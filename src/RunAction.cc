 ...
 : G4UserRunAction()
{
  ...
  //Creating Ntuple
  analysisManager->CreateNtuple("Target", "energy outside target box");
  ...
  //Creating Ntuple
  analysisManager->CreateNtuple("LYSO", "energy on LYSO box");
  analysisManager->CreateNtupleIColumn("EventID");
  analysisManager->CreateNtupleDColumn("KinEnergy");
  analysisManager->CreateNtupleDColumn("Time");
  analysisManager->CreateNtupleIColumn("Particle");
  ...
  analysisManager->CreateNtuple("ntuple", "energy deposit");
  analysisManager->CreateNtupleDColumn("LYSOen");
  analysisManager->FinishNtuple();
